...
export const Footer = () => {
  return (
    ...
    <footer className="w-full bg-white dark:bg-gray-800 shadow-sm mt-auto mt-1">
    <div className="max-w-screen-xl mx-auto p-4 md:flex md:items-center md:justify-between">
      ...
      <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
        <li>
          <a href="https://www.instagram.com/accounts/login/?hl=en" target="_blank" rel="noreferrer" className="hover:underline me-4 md:me-6">Instagram</a>
        </li>
        <li>
        ...
        <li>
          <a href="https://github.com/login" target="_blank" rel="noreferrer" className="hover:underline">GitHub</a>
        </li>
      </ul>
    </div>
  </footer>
